                             ...
                             {{-- @foreach ($names as $name) --}}
                                   <div class="container">
                                       <div class="fb-profile">
                                           <div class="col-sm-1">
                                               <a href="user-display"><img class="post-avatar" src="images/profile.png" alt="profile" ></a>
                           ...
                           <div class="col-md">
                                <div class="card card-default">
                                   <div class="card-header right-card-header">
                                    ...
                                    {{-- @foreach ($posts as $post) --}}
                                      {{-- <p><b> {{$tweet->tweet}} <b><br/>
                                       ...
                                       <div class="container">
                                          <div class="row">
                                              <div class="col-md-3 post-buttons">
                                                  {{-- <a href="/edit-post/{{$post->id}}"><i class="far fa-edit"></i></a> --}}
                                              </div>
                                              <div class="col-md-3 post-buttons">
                                  ...
                                  <div class="container">
                                      <div class="row">
                                          <div class="col-sm-2">
                                           ...
                                           <div class="col-md-6">
                                               ...
                                               @csrf
                                                  <textarea name="comment" class="form-control comment-box" rows="1" placeholder="" required></textarea>
                                      ...
                                      <div class="row">
                                          <div class="col-md-2 post-buttons">
